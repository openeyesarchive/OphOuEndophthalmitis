...
class OphOuEndophthalmitisModule extends BaseEventTypeModule
{
	...
	public function init() {
		...
		$this->setImport(array(
			'OphOuEndophthalmitis.models.*',
			'OphOuEndophthalmitis.components.*',
		));
		
		$this->moduleShortSuffix = "endophthalmitis";
	}
